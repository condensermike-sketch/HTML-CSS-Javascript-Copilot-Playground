...
window.JOLLIBEE_MENU = {
  ...
  groups: {
    ...
    mealSandwich: { title:"Chicken Sandwich", required:true, options:[
    ...
    sauces: { title:"Sauces", quantity:true, options:[
    ...
    burgerUpgrades: { title:"Popular Upgrades", multiselect:true, required:false, options:[
    ...
    burgerRemovals: { title:"Customize Your Meal", multiselect:true, required:false, options:[
  ...
  nestedGroups: { fountain: { title:"Fountain Drink", options:[
  ...
  items: {
    "chicken-nuggets-5pc":{id:"chicken-nuggets-5pc",category:"nuggets",name:"5pc Chicken Nuggets",shortName:"5pc Chicken Nuggets",description:"Crispy, juicy, perfectly seasoned chicken breast nuggets with 100% white meat made for dipping or enjoying on their own.",price:4.49,calories:0,customizations:["sauces"],image:"chicken-nuggets-5pc.jpg"},
    "mangonada-paradise-freeze":{id:"mangonada-paradise-freeze",category:"limited-time",name:"Mangonada Paradise Freeze",shortName:"Mangonada Paradise Freeze",description:"Refreshing mango blended with tangy chamoy and a zesty chili-lime twist — a vibrant, sweet, and spicy freeze that awakens your taste buds with every sip.",price:5.29,calories:0,customizations:[],image:"mangonada-paradise-freeze.png"},
    "mango-freeze":{id:"mango-freeze",category:"limited-time",name:"Mango Freeze",shortName:"Mango Freeze",description:"Refreshing mango blended into a smooth freeze — a pure, fruity delight that's refreshingly sweet with every sip.",price:5.29,calories:0,customizations:[],image:"mango-freeze.jpeg"},
    "chickenjoy-2pc-2sides":{id:"chickenjoy-2pc-2sides",category:"chickenjoy",name:"2pc Chickenjoy w/ Biscuit + 2 Sides",shortName:"2pc Chickenjoy + 2 Sides",description:"2pc of our next-level crispy, next-level juicy Chickenjoy fried chicken served with 2 regular sides.",price:10.99,calories:1050,customizations:["chicken","side","side2"],image:"chickenjoy-2pc-2sides.jpg"},
    "chicken-sandwich-deluxe":{id:"chicken-sandwich-deluxe",category:"sandwiches",name:"Spicy Chicken Sandwich Combo",shortName:"Spicy Chicken Sandwich Combo",description:"A crispy juicy hand-breaded chicken breast fillet, spread with sriracha mayo and served with fresh jalapenos on a toasted brioche bun with a side of regular Jolly Crispy Fries and fountain drink.",price:10.49,calories:910,customizations:["side","drink"],image:"spicy-chicken-sandwich-combo.png"},
    "chicken-sandwich-and-pie-meal-deal":{id:"chicken-sandwich-and-pie-meal-deal",category:"meal-deals",name:"Chicken Sandwich and Pie Meal Deal",shortName:"Chicken Sandwich and Pie Meal Deal",description:"Our Original or Spicy Chicken Sandwich served with regular Jolly Crispy Fries, a fountain drink, and a dessert pie.",price:11.00,calories:890,customizations:["mealSandwich","side","drink","pie"],image:"chicken-sandwich-and-pie-meal-deal.png"},
    "1pc-chickenjoy-jolly-spaghetti-and-drink":{id:"1pc-chickenjoy-jolly-spaghetti-and-drink",category:"perfect-pairs",name:"1pc Chickenjoy w/ Jolly Spaghetti and Drink",shortName:"1pc Chickenjoy + Jolly Spaghetti",description:"1pc of our next-level crispy, next-level juicy Chickenjoy fried chicken served with Jolly Spaghetti and a fountain drink.",price:13.49,calories:830,customizations:["perfectPairChicken","gravy","drink"],image:"1pc-chickenjoy-jolly-spaghetti-and-drink.png"},
    "family-bucket-8pc":{id:"family-bucket-8pc",category:"family",name:"Jolly Spaghetti Family Pack",shortName:"Jolly Spaghetti Family Pack",description:"Our one-of-a-kind spaghetti topped with our signature sweet-style sauce, loaded, ground beef, and hotdog and topped with melty cheese. Serves 3-5.",price:19.99,calories:1830,customizations:[],image:"jolly-spaghetti-family-pack.jpg"},
    "chicken-tenders-4pc-meal-deal":{id:"chicken-tenders-4pc-meal-deal",category:"tenders",name:"4pc Chicken Tenders",shortName:"4pc Chicken Tenders",description:"4 crispy, hand-breaded Jollibee Chicken Tenders made with 100% juicy white meat, served with our Signature Tender Sauce.",price:9.29,calories:0,customizations:["dip"],image:"chicken-tenders-4pc.jpg"},
    "angus-cheeseburger":{id:"angus-cheeseburger",category:"burgers",name:"Angus Cheeseburger",shortName:"Angus Cheeseburger",description:"We make our Angus Beef burgers fresh when you order it. Pressed and seared on the grill with melted cheese, thick crunchy pickles, sliced red onions, ketchup and our signature sauce. Served on a butter-toasted bun.",price:6.49,calories:667,customizations:["burgerUpgrades","burgerRemovals"],image:"angus-cheeseburger.png"},
    "angus-cheeseburger-combo":{id:"angus-cheeseburger-combo",category:"burgers",name:"Angus Cheeseburger Combo",shortName:"Angus Cheeseburger Combo",description:"We make our Angus Beef burgers fresh when you order it. Pressed and seared on the grill with melted cheese, thick crunchy pickles, sliced red onions, ketchup and our signature sauce. Served on a butter-toasted bun with Jolly Crispy Fries and a fountain drink.",price:10.99,calories:1007,customizations:["burgerUpgrades","burgerRemovals","side","drink"],image:"angus-cheeseburger-combo.png"},
    "jolly-spaghetti-solo":{id:"jolly-spaghetti-solo",category:"spaghetti",name:"Jolly Spaghetti",shortName:"Jolly Spaghetti",description:"Our one-of-a-kind spaghetti topped with our signature sweet-style sauce, loaded, ground beef, and hotdog and topped with melty cheese.",price:5.99,calories:0,customizations:[],image:"jolly-spaghetti-solo.jpg"},
    "palabok-fiesta":{id:"palabok-fiesta",category:"palabok",name:"Palabok Fiesta",shortName:"Palabok Fiesta",description:"A traditional Filipino noodle dish covered in garlic sauce, sauteed pork, and egg. Note: Palabok sauce contains pork that cannot be removed.",price:8.99,calories:410,customizations:[],image:"palabok-fiesta.png"},
    "burger-steak-2pc":{id:"burger-steak-2pc",category:"burger-steak",name:"2pc Burger Steak w/ 1 Side",shortName:"2pc Burger Steak",description:"2 beef burger patties smothered with mushroom gravy. Served with white rice.",price:10.99,calories:570,customizations:["side"],image:"burger-steak-2pc.jpg"},
    "burger-steak-3pc":{id:"burger-steak-3pc",category:"burger-steak",name:"3pc Burger Steak w/ 1 Side & Drink",shortName:"3pc Burger Steak",description:"3 beef burger patties smothered with mushroom gravy. Served with white rice and a fountain drink.",price:15.99,calories:750,customizations:["side","drink"],image:"burger-steak-2pc.jpg"},
    "adobo-rice":{id:"adobo-rice",category:"sides",name:"Adobo Rice",shortName:"Adobo Rice",description:"A side of Adobo Rice.",price:3.99,calories:250,customizations:[],image:"adobo-rice.png"},
    "side-jolly-spaghetti":{id:"side-jolly-spaghetti",category:"sides",name:"Side Jolly Spaghetti",shortName:"Side Jolly Spaghetti",description:"A side portion of our one-of-a-kind Jolly Spaghetti.",price:3.99,calories:360,customizations:[],image:"side-jolly-spaghetti.png"},
    "jolly-crispy-fries-large":{id:"jolly-crispy-fries-large",category:"sides",name:"Jolly Crispy Fries Large",shortName:"Large Jolly Crispy Fries",description:"A large serving of our Jolly Crispy Fries.",price:3.99,calories:520,customizations:[],image:"jolly-crispy-fries.jpg"},
    "jolly-crispy-fries":{id:"jolly-crispy-fries",category:"sides",name:"Jolly Crispy Fries",shortName:"Jolly Crispy Fries",description:"A regular serving of our Jolly Crispy Fries.",price:2.69,calories:340,customizations:[],image:"jolly-crispy-fries.jpg"},
    "mashed-potatoes-large":{id:"mashed-potatoes-large",category:"sides",name:"Mashed Potatoes Large",shortName:"Large Mashed Potatoes",description:"A large serving of our mashed potatoes and gravy.",price:3.99,calories:340,customizations:[],image:"mashed-potatoes.jpg"},
    "mashed-potatoes":{id:"mashed-potatoes",category:"sides",name:"Mashed Potatoes",shortName:"Mashed Potatoes",description:"A regular serving of our mashed potatoes and gravy.",price:2.69,calories:170,customizations:[],image:"mashed-potatoes.jpg"},
  ...
  seededOrders:[
    {id:"seed-order-1",dateLabel:"Aug 10",fulfillment:"Counter Pickup · Beverly",items:[
    ...
    {id:"seed-order-2",dateLabel:"Jul 28",fulfillment:"Drive-Thru · Beverly",items:[
